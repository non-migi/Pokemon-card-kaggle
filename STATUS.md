...
最終更新: 2026-08-10 (Claude Code) — **探索の是非が本番で決着。失点源はOODの長い裾と特定し、語彙拡張で対処**。
...
## ラダー状況(2026-08-10、active = 最新2提出のみ)

| 提出 | active | 内容 | score / 戦数 |
|---|---|---|---|
| **v5.4g** (提出直後) | **yes** | **bc_grim3**(13日/語彙186) + Grim合意60枚 + 純BC | 判定は80-100戦後 |
| **v5.1g** (sub 55172873) | **yes** | bc_grim2(7日/語彙143) + 同左 | **840.0 / 210戦** |
| v5.0g (sub 55174905) | no | 同左 + **探索BCS 8s** | 751.6 / 158戦で押し出し |
| v4.3a (sub 54731784) | no | bc_v2 + Alakazam | 795.7 / 315戦 |

**メダル基準(6,562チーム、08-08時点)**: 金 1079.4(23位) / **銀 905.0(328位)** / 銅 841.6(656位)。
自チームは **668位 / 840.0** で**銅ラインから-1.6点**。銀までは+65.0点。

⚠️ v5.4gの初期scoreは読まない。v4.3aは78戦で920.7 → 315戦で795.7へ収束した。
...
- (空き) — 08-10時点で実行中のジョブなし。v5.4g提出済み、次は約2日後のラダー判定。
