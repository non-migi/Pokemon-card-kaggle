...
v6.0oは初日6戦862.9 → 50戦800 → 300戦859 → 600戦873 → 1000戦875〜909で推移し、
08-29の1000戦到達後は 875〜909 の帯で振れて 09-01 07:55 UTC 以降 905.8 に凍結。
v5.12g 2本目は 300戦831 → 600戦798 → 940戦759 まで下げた後、1000戦目で 765→835 に戻して凍結。
1000戦到達で対戦が止まる仕様(両提出とも episodes=1000 で固定)。
...
2. 一方で v5.12g は独立2試行が 834.6 / 843.6 とよく一致し、**bc_grim7系の真値は約840**と
   ...
   ペア構成が最終的に効いた。
3. 1000戦上限があるため「締切後2週間で収束」ではなく「1000戦で凍結」が実際の終了条件だった。
